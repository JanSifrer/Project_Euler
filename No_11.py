def produkt(x):
    sez = '''08 02 22 97 38 15 00 40 00 75 04 05 07 78 52 12 50 77 91 08
...
01 70 54 71 83 51 54 69 16 92 33 48 61 43 52 01 89 19 67 48'''
    ...
    for q in sez1:
        for i in range(len(q)-7):
            ...
            tretji = q[i+4] + q[i+5]
            cetrti = q[i+6] + q[i+7]
            delen_produkt = int(prvi) * int(drugi) * int(tretji) * int(cetrti)
            if delen_produkt > produkt:
                produkt = delen_produkt
## 
##    L = []
